    ...
    var login = <div className="fullscreen">
      <div id="wallet-select" className="password">
        ...
        <div className="kyc">
          ...
          <p>KYC approval generally takes 8 hours, but in some cases may take 5 business days. If more than 5 business days have passed since you KYC'd, please submit a support ticket here:
    ...
    if (props.dialog.type === "withdraw") {
      header = <div className="header">
        ...
        <div className="content">
          ...
          <p className="warning">Note: Withdrawals must be between 10 and 500 DAI to be accepted, otherwise you will need to contact <a href="mailto:support@microtick.com">support@microtick.com</a> for a refund.</p>
        </div>
      </div>
      action = <button className="button" onClick={() => props.dialog.submit()}>Submit</button>
    }
